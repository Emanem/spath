...
namespace {
	geom::vec3 render_step(const geom::ray& r, const geom::triangle* tris, const scene::material* mats, const size_t n_tris, const int depth = 0) {
	...
	void render_core(const int idx, const view::viewport& vp, const geom::triangle* tris, const scene::material* mats, const size_t n_tris, scene::bitmap& out) {
	...
	void render_pt(const view::viewport& vp, const geom::triangle* tris, const scene::material* mats, const size_t n_tris, scene::bitmap& out) {
